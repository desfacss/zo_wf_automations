...
import { BuildingOutlined, EnvironmentOutlined, UserOutlined } from '@ant-design/icons';
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-7xl mx-auto px-6 py-8">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
            <UserOutlined className="w-12 h-12 text-yellow-600 mx-auto mb-4" />
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-lg">
              <BuildingOutlined className="w-8 h-8 text-blue-600" />
              <div>
            ...
            <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg">
              <EnvironmentOutlined className="w-8 h-8 text-green-600" />
              <div>
